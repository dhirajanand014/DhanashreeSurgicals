package aegismatrix.com.dhanashreesurgicals;
 ...
 */
public class DSSplashScreen extends AppCompatActivity implements Observer {
    ...
    public void animateSlideLeft(Context context) {
        ((DSSplashScreen) context).overridePendingTransition(R.anim.animate_slide_left_enter, R.anim.animate_slide_left_exit);
    }
    ...
    public void update(Observable observable, Object intent) {
        if (null != intent) {
            ...
            mTextView.setBackgroundColor(ContextCompat.getColor(DSSplashScreen.this, status ? R.color.colorGreen : R.color.design_default_color_error));
            // show the snackbar
            snackBar.show();

            if (status) {
                Intent mainIntent = new Intent(DSSplashScreen.this, MainActivity.class);
